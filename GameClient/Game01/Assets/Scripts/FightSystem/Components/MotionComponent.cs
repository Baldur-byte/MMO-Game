/**********************************************************
文件：MotionComponent.cs
作者：auus
邮箱：#Email#
日期：2023/03/21 16:51:25
功能：Nothing
/**********************************************************/
...
/// <summary>
/// 运动组件，管理战斗实体的移动、跳跃、击飞、奔跑等运动功能
/// </summary>
public class MotionComponent : Component
{
    public override bool DefaultEnable { get; set; } = true;

    public Vector3 Position { get => GetEntity<CombatEntity>().Postion; set => GetEntity<CombatEntity>().Postion = value; }
    ...
    public void RunAI()
    {
        ...
        MoveTimer = new GameTimer(RandomHelper.RandomNumber(20, 40) / 10);
        IdleTimer.Reset();
        originPos = Position;
    }
